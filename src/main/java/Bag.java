...
public abstract class Bag {
    ...
    public boolean addItem(String item){
        if(numberOfContents < this.getCapacity()){
            this.contents = Arrays.copyOf(contents, this.getNumberOfContents() + 1);
    ...
    public String popItem(){
        if(numberOfContents > 0){
            ...
            this.contents = Arrays.copyOf(this.contents, this.getNumberOfContents() - 1);
            numberOfContents--;
            return last;
        }
        return null;
